...
module.exports = class Creator extends EventEmitter {
  ...
  async create (cliOptions = {}, preset = null) {
    ...
    const AOTE_TEXT = `${chalk.bold.dim.yellowBright(`    ___   ____  ____________
   /   | / __ \\/_  __/ ____/
  / /| |/ / / / / / / __/   
 / ___ / /_/ / / / / /___   
/_/  |_\\____/ /_/ /_____/   
                            `)}
${chalk.bold.dim.yellowBright('最后的奥特曼')}`
    const upgradeBox = require('boxen')(AOTE_TEXT, {
      align: 'center',
      borderColor: 'red',
      borderStyle: 'bold',
      dimBorder: true,
